import { AUTH_CONS } from './auth.constant.js';
import { RESUME_CONS } from './resume.constant.js';
  ...
  AUTH: {
    COMMON: {
      ...
      PASSWORD: {
        ...
        MIN_LENGTH: `비밀번호는 ${AUTH_CONS.MIN_PASSWORD_LENGTH}자리 이상이어야 합니다.`,
      },
      PASSWORD_CONFIRM: {
  ...
  RESUMES: {
    COMMON: {
      ...
      CONTENT: {
        ...
        MIN_LENGTH: `자기소개는 ${RESUME_CONS.MIN_RESUME_LENGTH}자 이상 작성해야 합니다.`,
      },
